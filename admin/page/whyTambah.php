<div class="col-xs-12">
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Why</h3>
            <?php
            if(isset($_POST['aksi'])){
                ...
                $link->query("INSERT INTO why(title,description,pict,pict_hover) VALUES('$a','$b','$c','$d')");
            ?>
            <div class="callout callout-info">
                <h4>Sukses!</h4>
                Data berhasil ditambah<br />
             </div>
             <meta http-equiv="refresh" content="1; ./index.php?p=why">
             <?php } ?>
             </div>
            <!-- /.box-header -->
            <!-- form start -->
